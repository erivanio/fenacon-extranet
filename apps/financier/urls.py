...
from apps.financier.views import TravelRefundCreateView, TravelRefundListView, TravelRefundUpdateView, TravelRefundDeleteView
...
urlpatterns = patterns('',
    ...
    url(r'^solicitacao-reembolso/deletar/(?P<pk>\d+)/$', TravelRefundDeleteView.as_view(), name='delete_refund'),
)
